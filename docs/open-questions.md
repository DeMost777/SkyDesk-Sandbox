...
4. **Где предлагать сохранить Default Office.** Спецификация: «при ручном выборе Office», место не указано.
   Сейчас: checkbox в строке Found, только после успешного открытия через выбранный вручную Office. Заглушка Found остаётся, пока команда утверждает PNR Search; уйдёт в задаче 2.5 — продолжение в #24.
...
24. **Где предлагать сохранить Default Office, когда нет заглушки Found.** Сейчас checkbox «Use this as my default office» живёт в заглушке Found (#4), а успешный поиск будет сразу открывать Booking.
   Сейчас: не актуально, пока Found — заглушка (переход в Booking отложен до утверждения PNR Search, решение пользователя 2026-09-25). Решить до задачи 2.5. Варианты: в Header Booking, в чате, в Settings, не предлагать.
