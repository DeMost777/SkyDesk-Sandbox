...
11. **Текст Error «Something went wrong. Please try again.» рядом с кнопкой «Try again».** Текст из Figma; вместе с кнопкой «try again» звучит дважды. Вариант: «Amadeus is not responding.» + «Try again».
   Сейчас: текст из Figma без изменений.
   Решает: design. Добавлено 2026-09-23.

12. **После «Choose another office» запускать поиск сразу?** Сейчас агент выбирает Office, затем снова нажимает поиск. По принципу flow поиск можно запускать сразу после выбора.
   Сейчас: нужен повторный клик.
   Решает: product. Добавлено 2026-09-23.
