...
- [2.1] Каркас Booking Overview — план. Страница открывается после успешного поиска PNR: шапка с обзором бронирования (Figma `308:12504`) и заголовок «Booking Overview», под ним — зона виджетов друг под другом (пока пустая). Mock-данные бронирования связаны с введённым PNR. Страница — Figma `7994:305661`; конечный вид (виджеты-аккордеоны и чат справа) — `4678:125394`, только для планирования. Первый шаг — план с разбивкой на задачи, утверждается пользователем по шагам — Фаза 2
